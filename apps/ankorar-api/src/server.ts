...
import { noteController } from "./routes/noteController";
...
import { NoteModule } from "./models/note/NoteModule";
...
export function createServerInstance(
  ...
  server.appendModule(NoteModule);
  ...
  server.appendController(noteController);
