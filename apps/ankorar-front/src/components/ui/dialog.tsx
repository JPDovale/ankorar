      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="ring-offset-background text-muted-foreground hover:text-foreground hover:bg-accent/80 focus:ring-ring absolute top-4 right-4 rounded-md opacity-80 transition-colors focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
          >
            <XIcon />
